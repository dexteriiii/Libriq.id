            ...
            <div class="relative z-10 text-white max-w-lg">
                ...
                <div class="mt-10 space-y-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="text-white font-semibold text-sm">Katalog Terintegrasi</div>
                            <div class="text-orange-200 text-xs">Sinkron otomatis dengan Google Books API</div>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-lg bg-white/15 flex items-center justify-center shrink-0">
                        ...
                        <div>
                            <div class="text-white font-semibold text-sm">Sirkulasi & Denda Otomatis</div>
                            <div class="text-orange-200 text-xs">Peminjaman, pengembalian, dan denda dihitung real-time</div>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-lg bg-white/15 flex items-center justify-center shrink-0">
                        ...
                        <div>
                            <div class="text-white font-semibold text-sm">Multi-Role Access</div>
                            <div class="text-orange-200 text-xs">Dashboard terpisah untuk Admin & Anggota</div>
                        </div>
                    </div>
                </div>
            </div>
